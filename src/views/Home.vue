    ...
    <div class="bottom_content">
      <div class="bottom_content1">
        <ul class="d-flex justify-content-around">
          <li><i>多</i>品类齐全，轻松购</li>
          <li><i>快</i>多仓直发，急速配送</li>
          <li><i>好</i>正品行货，精致服务</li>
          <li><i>省</i>天天低价，畅选无忧</li>
        </ul>
      </div>
      <div class="d-flex justify-content-around bottom_middle">
...
.bottom_middle>ul>li:nth-child(1){
    padding-bottom: 6px;
    font-weight: 700;
    font-size: 14px;
}
.bottom_middle>ul li:not(:nth-child(1)){
  margin-bottom: 10px;
}
.bottom_nav a {
    color: #666;
